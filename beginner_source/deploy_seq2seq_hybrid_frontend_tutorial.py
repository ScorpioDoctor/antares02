...
######################################################################
# 本教程将介绍使用PyTorch的混合前端(Hybrid Frontend)将序列模型转换为Torch Script的过程。
# 我们将转换的模型是Chatbot教程中的Chatbot模型。您可以将本教程视为Chatbot教程的“第2部分”，
# 并部署您自己的预训练模型，也可以从本文档开始，并使用我们提供的预训练模型。
# 在后一种情况下，您可以参考原始的Chatbot教程，了解有关数据预处理、模型理论和定义
# 以及模型训练的详细信息。
#
# 什么是 Hybrid Frontend?
# ----------------------------
